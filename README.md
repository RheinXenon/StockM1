...
1. **新手**：先使用数据可视化系统，熟悉股票数据和技术指标
2. **进阶**：在理解技术指标后，尝试AI智能交易系统
3. **高级**：修改AI Agent的策略，测试不同的交易算法
...
- **初始资金**：100万人民币
- **模拟时间**：2020年全年
- **股票池**：10只优质A股（贵州茅台、招商银行、万科A、中国平安、五粮液、恒瑞医药、宁德时代、比亚迪、伊利股份、立讯精密）
...
#### Q: API调用费用是多少？
**A:** 
- Qwen3-30B公益API目前免费或有较大额度
- 模拟一年大约需要调用500-1000次API
- 具体费用请查看阿里云定价
...
- ✅ **完全本地化**：数据存储在本地SQLite，无需云服务
- ✅ **模块化设计**：可视化与AI系统解耦，可独立使用
- ✅ **真实性保证**：AI交易模拟严格防止未来信息泄露
- ✅ **可扩展性强**：易于添加新的技术指标和AI策略
- ✅ **开箱即用**：提供详细文档和一键启动脚本
