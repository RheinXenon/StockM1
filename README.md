...
**现已支持前端可视化运行！** 不再需要在终端运行AI模拟，可以通过Web界面直接配置和启动AI交易。
...
**配置界面**：
![AI炒股模拟运行1](images/AI炒股模拟运行1.png)

**运行过程**：
![AI炒股模拟运行2](images/AI炒股模拟运行2.png)

**实时监控**：
![AI炒股模拟运行3](images/AI炒股模拟运行3.png)

**结果展示**：
![AI炒股模拟运行4](images/AI炒股模拟运行4.png)
